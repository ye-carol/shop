<template>
  <div class="sales-board">
      ...
      <v-dialog :is-show="isShowErrDialog" @on-close="hideDialog('isShowErrDialog')">
        支付失败！
      </v-dialog>
      <v-check-order :is-show-check-dialog="isShowCheckOrder" :order-id="orderId" @on-close-check-dialog="hideDialog('isShowCheckOrder')"></v-check-order>
